...
async function loadArticles() {
  try {
    const sources = ["data/articles.json", "data/atherosclerosis.json", "data/heart-lifetime-beats.json", "data/vascular-endothelium.json", "data/coronary-stent-aftercare.json"];
